  ...
  def create
    ...
    respond_to do |format|
      if @page.save
        ...
        format.html { redirect_to blog_url(@page.blog_id), notice: "Page was successfully created." }
  ...
  def update
    respond_to do |format|
      if @page.update(page_params)
        format.html { redirect_to blog_url(@page.blog_id), notice: "Page was successfully updated." }

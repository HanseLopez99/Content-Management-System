...
class ContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content" do
    assert_difference("Content.count") do
      post contents_url, params: { content: { blog_id: @content.blog_id, page_id: @content.page_id } }
    end
  ...
  test "should update content" do
    patch content_url(@content), params: { content: { blog_id: @content.blog_id, page_id: @content.page_id } }
